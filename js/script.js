...
function calculateGpa()
{
    ...
    // Display the result
    document.getElementById("result").innerHTML = "<br><br>Total Marks: " + total_score + "<br><br>Total Credits: " + total_credits + "<br><br>Total Credit Points: " + total_credpoints + "<br><br>SGPA: " + sgpa ;
}